...
function showCongratsOverlay(text) {
	...
	overlay.style.background = 'radial-gradient(circle at center, rgba(100, 50, 150, 0.3), rgba(0, 0, 0, 0.95))';
	...
	card.style.background = 'linear-gradient(145deg, rgba(50, 30, 80, 0.95), rgba(20, 10, 40, 0.98))';
	card.style.color = '#fff';
	card.style.padding = '40px 50px';
	card.style.borderRadius = '20px';
	card.style.border = '3px solid rgba(150, 100, 255, 0.4)';
	card.style.boxShadow = '0 25px 80px rgba(150, 100, 255, 0.3), inset 0 0 50px rgba(150, 100, 255, 0.1)';
	...
	title.style.background = 'linear-gradient(135deg, #00ff00, #00d466, #00a86b)';
	title.style.WebkitBackgroundClip = 'text';
	title.style.WebkitTextFillColor = 'transparent';
	title.style.textShadow = '0 0 30px rgba(0, 255, 0, 0.5)';

	const body = document.createElement('div');
	body.style.fontSize = '18px';
	body.style.lineHeight = '1.8';
	body.style.color = '#e0d0ff';
	...
	hint.style.textShadow = '0 0 15px rgba(255, 204, 102, 0.6)';
